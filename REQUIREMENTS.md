...
| R-UX-06 | Provide sidebar navigation and user identity treatment shown in the GUI reference. | Implemented locally | [#8](https://github.com/smartalex32/Workforce-Compass/issues/8) |
